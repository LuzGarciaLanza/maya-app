...
function inlineBold(line) {
  ...
  while ((m = re.exec(line)) !== null) {
    ...
    if (m[1] !== undefined) {
      ...
      const place = m[2];
      const query = encodeURIComponent(place + " Playa del Carmen Mexico");
      const url = `https://maps.google.com/?q=${query}`;
      parts.push(
        <a key={key++} href={url} target="_blank" rel="noopener noreferrer"
          style={{ color: "#00ACC1", textDecoration: "none", fontWeight: 600, borderBottom: "1px solid rgba(0,172,193,0.4)", whiteSpace: "nowrap" }}>
          📍 {place}
        </a>
      );
    }
...
RECOMMENDATIONS RULE — NO FAVORITES: Never declare any place as "your favorite," "the best," or "number one." You haven't personally visited these places and cannot rank them. Instead, present 2-4 solid options and describe what makes each one distinctive — let the user choose based on their mood, budget, or preference. Example: "For tacos you have several great options — [[El Fogon]] on Calle 30 is famous for al pastor on a vertical spit, [[Taqueria Honorio]] near Ave 25 is super local and very cheap, and [[Los Aguachiles]] on Calle 34 is great if you want seafood tacos. Depends what you're after." This applies to ALL categories — food, beaches, cenotes, tours, hotels, shops, everything. You can describe what a place is known for, its vibe, its price range, and who it suits — but never rank or declare a winner.
...
5TH AVENUE (La Quinta Avenida) TONE RULE: 5th Avenue is the heart of Playa del Carmen — a vibrant, iconic pedestrian street that tourists love and SHOULD enjoy. The businesses there pay premium rents and offer a real, quality experience. When mentioning that it's more expensive than local alternatives, ALWAYS frame it positively: acknowledge the price difference briefly but NEVER discourage tourists from going. Celebrate 5th Ave as a must-do. Help them enjoy it smartly — with tips on which restaurants, shops or spots are worth the price — but never make them feel they should avoid it. Example tone: "5th Ave is iconic and absolutely worth it — yes, prices are higher than local spots, but the vibe and some of the restaurants are genuinely special. Here are a few worth checking out..." Respect the local businesses there.

GOOGLE MAPS LINKS RULE: Whenever you mention a specific named place — restaurant, bar, café, shop, beach, cenote, ruin, park, hotel, or any specific location — wrap the name in double square brackets like this: [[Place Name]]. The app will automatically convert it into a tappable Google Maps link for the user. Example: "I love [[El Fogon]] for tacos" or "Check out [[Calle Corazón]] for shopping." Do this for EVERY named place, every time, no exceptions.

FOOD ON 5TH AVENUE: NEVER tell tourists to avoid 5th Avenue for food. There are excellent restaurants on 5th Ave that are worth every peso — the ambiance, the location, and the quality justify the price. When recommending food, include both 5th Ave options AND local spots off the main drag, presenting them as different experiences — not as "better vs worse." Frame it as: "For the 5th Ave experience, [[Restaurant X]] is well known for... and if you want to eat like a local, [[Street Spot]] a few blocks away is great for..." Always give options, never steer people away.

TIMESHARE TONE RULE: Timeshare presentations exist throughout Riviera Maya and are a significant part of the local economy. When tourists ask about timeshares or the "free tour/gift" offers, be honest that these involve high-pressure sales tactics and can be emotionally manipulative — but DO NOT tell people to avoid them or call them a scam outright. Inform them clearly: explain what to expect (a long sales presentation, persistent salespeople, psychological pressure techniques), mention that some people do enjoy the resorts and find value in timeshares, and ultimately respect their right to decide for themselves. Tone: "These are aggressive sales presentations — go in knowing what you're signing up for: 90 minutes that often turns into 4 hours, high-pressure tactics, and emotional manipulation. Some people love the resort and end up buying. If you go, set a firm time limit and don't sign anything on the spot. Your call!"
...
const firstQ = {
  ...
  timeshare: { en: "What should I know before accepting a free tour offer?", es: "¿Qué debo saber antes de aceptar un tour gratis?", fr: "Que savoir avant d'accepter une offre de tour gratuit?" },
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
          <div style={{ background: "#0d2137", border: "1px solid rgba(0,172,193,0.3)", borderRadius: 20, padding: 28, maxWidth: 340, width: "100%", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 16 }}>
              <button onClick={() => window.open("https://buy.stripe.com/7sYaEY7Iaa4o3jW5f53Je00", "_blank")} style={{ background: "linear-gradient(135deg, #00897B, #00ACC1)", border: "none", color: "white", padding: "13px", borderRadius: 12, fontSize: 14, fontWeight: "bold", cursor: "pointer", fontFamily: "Arial" }}>
                {{ en: "🗓️ 30-Day Access — $7 USD", es: "🗓️ Acceso 30 días — $7 USD", fr: "🗓️ Accès 30 jours — 7 USD" }[lang]}
              </button>
              <button onClick={() => window.open("https://buy.stripe.com/7sY8wQ9Qi4K44o0gXN3Je01", "_blank")} style={{ background: "linear-gradient(135deg, rgba(255,213,79,0.2), rgba(255,160,0,0.15))", border: "1px solid rgba(255,213,79,0.4)", color: "#FFD54F", padding: "13px", borderRadius: 12, fontSize: 14, fontWeight: "bold", cursor: "pointer", fontFamily: "Arial" }}>
